...
const translationsData: Record<Language, Translations> = {
  fr: {
    ...
    home: {
      dailyBriefTitle: "Daily Brief IA de la journée",
      liveSync: "Live Sync",
      regenBrief: "Régénérer mon brief",
      ...
      challengeTag: "Défi Interactif NACORA AI",
      ...
      challengeLaunchAi: "Lancer l'Assistant IA Nacora",
      challengeHelpText: "Chaque action de réseautage validée renforce ton score d'employabilité et active les recommandations automatiques du cabinet.",
    ...
    hubIa: {
      title: "Hub IA Carrière & Coaching",
      subtitle: "Des conseillers spécialisés prêts à t'entraîner et propulser tes candidatures",
      selectSpecialist: "Spécialistes IA NACORA",
      ...
      interviewCoachDesc: "Entraîne-toi aux questions pièges et aux pitchs de présentation",
      linkedinStrategist: "Stratège LinkedIn & Réseau",
      linkedinStrategistRole: "Approches & Messages",
      linkedinStrategistDesc: "Rédige des messages d'approche percutants vers recruteurs et alumni",
      ...
      send: "Envoyer",
      thinking: "L'IA analyse tes données...",
  ...
  en: {
    ...
    home: {
      dailyBriefTitle: "AI Daily Career Brief",
      liveSync: "Live Sync",
      ...
      challengeTag: "NACORA AI Interactive Challenge",
      ...
      challengeLaunchAi: "Launch NACORA AI Assistant",
      challengeHelpText: "Each completed networking action boosts your employability score and triggers automated firm recommendations.",
    ...
    hubIa: {
      title: "Career AI Hub & Coaching",
      subtitle: "Dedicated specialist advisors ready to coach and accelerate your applications",
      selectSpecialist: "NACORA AI Specialists",
      ...
      interviewCoachDesc: "Practice tough questions, objection handling, and elevator pitches",
      linkedinStrategist: "LinkedIn & Network Strategist",
      linkedinStrategistRole: "Outreach & Messaging",
      linkedinStrategistDesc: "Craft high-impact outreach messages to recruiters and alumni",
      ...
      send: "Send",
      thinking: "AI is analyzing your profile and context...",
      newChat: "New Session",
